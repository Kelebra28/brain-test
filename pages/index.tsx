    ...
    <>
      <div>
        ...
        <ul>
          ...
          <li>
            • Si está más de acuerdo que en desacuerdo con el ítem señale la
            casilla SI, si, por el contrario, está más en desacuerdo que de
            acuerdo, señale la casilla NO.
          </li>
          <li>
            • Asegúrese de que contesta lo que usted realmente piensa, no lo que
